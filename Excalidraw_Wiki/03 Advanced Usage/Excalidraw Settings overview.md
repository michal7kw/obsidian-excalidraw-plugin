...
source: https://excalidraw-obsidian.online/WIKI/03%20Advanced%20Usage/Excalidraw%20Settings%20overview.md
---
...
Filename for a new drawing is: [Excalidraw 2025-07-21 20.35.md](https://www.youtube.com/channel/UCC0gns4a9fhVkGkngvSumAQ)  
Filename for a new embedded drawing is: [{NOTE_NAME}2025-07-21 20.35.md](https://www.youtube.com/channel/UCC0gns4a9fhVkGkngvSumAQ)
...
The first part of the filename for new drawings created when cropping an image. Leave empty if you don't need a prefix.

##### Crop file suffix

The last part of the filename for new drawings created when cropping an image. Leave empty if you don't need a suffix.

##### Annotation file prefix

The first part of the filename for new drawings created when annotating an image. Leave empty if you don't need a prefix.

##### Annotation file suffix

The last part of the filename for new drawings created when annotating an image. Leave empty if you don't need a suffix.
...
##### Enable double-click text create
...
**Toggle OFF:** Right-handed mode.

### Hotkey overrides

Some of the Excalidraw hotkeys such as `CMD+Enter` to edit text or `CMD+K` to create an element link conflict with Obsidian hotkey settings. The hotkey combinations you add below will override Obsidian's hotkey settings while using Excalidraw, thus you can add `CMD+G` if you want to default to Group Object in Excalidraw instead of opening Graph View.
...
When opening a link, Excalidraw will focus on the existing tab if the file is already open. Enabling this setting overrides 'Reuse Adjacent Pane' when the file is already open except for the 'Open the back-of-the-note of the selected excalidraw image' command palette action.
...
This setting controls how Excalidraw files are exported to PDF using Obsidian's built-in **Export to PDF** feature.  
...
See the other related setting for [Markdown Reading Mode](#MDReadingMode) under 'Appearance and Behavior' further above.  
...
A0A1A2A3A4A5A6LegalLetterTabloidLedgerHD ScreenMATCH IMAGE
...
Use image scale (may span multiple pages)Fit to pageFit to max 2-pagesFit to max 4-pagesFit to max 6-pagesFit to max 8-pagesFit to max 12-pagesFit to max 16-pages
...
WhiteUse scene colorCustom color

##### Position on Page

CenterCenter LeftCenter RightTop LeftTop CenterTop RightBottom LeftBottom CenterBottom Right
...
VirgilCascadiaAssistantRubikBeastly-Regular.ttfGreatVibes-Regular.ttfchawp.ttfZCOOLQingKeHuangYou-Regular.ttfZCOOLKuaiLe-Regular.ttfRussoOne-Regular.ttfHelpMe.ttfGenos-ThinItalic.ttfGenos-Thin.ttfGenos-SemiBoldItalic.ttfGenos-SemiBold.ttfGenos-Regular.ttfGenos-MediumItalic.ttfGenos-Medium.ttfGenos-LightItalic.ttfGenos-Light.ttfGenos-Italic.ttfGenos-ExtraLightItalic.ttfGenos-ExtraLight.ttfGenos-ExtraBoldItalic.ttfGenos-ExtraBold.ttfGenos-BoldItalic.ttfGenos-Bold.ttfGenos-BlackItalic.ttfGenos-Black.ttfGenos-VariableFont_wght.ttfGenos-Italic-VariableFont_wght.ttfEraserRegular.ttfEraserDust.ttfChangaOne-Regular.ttfChangaOne-Italic.ttfVT323-Regular.ttfStarjedi.ttfPermanentMarker-Regular.ttfOrbitron-Bold.ttfMedievalSharp-Regular.woff2LuckiestGuy-Regular.ttfGugi.woff2Gugi.ttfCourier New.woff2Courier New.ttf
...
VirgilRubikBeastly-Regular.ttfGreatVibes-Regular.ttfchawp.ttfZCOOLQingKeHuangYou-Regular.ttfZCOOLKuaiLe-Regular.ttfRussoOne-Regular.ttfHelpMe.ttfGenos-ThinItalic.ttfGenos-Thin.ttfGenos-SemiBoldItalic.ttfGenos-SemiBold.ttfGenos-Regular.ttfGenos-MediumItalic.ttfGenos-Medium.ttfGenos-LightItalic.ttfGenos-Light.ttfGenos-Italic.ttfGenos-ExtraLightItalic.ttfGenos-ExtraLight.ttfGenos-ExtraBoldItalic.ttfGenos-ExtraBold.ttfGenos-BoldItalic.ttfGenos-Bold.ttfGenos-BlackItalic.ttfGenos-Black.ttfGenos-VariableFont_wght.ttfGenos-Italic-VariableFont_wght.ttfEraserRegular.ttfEraserDust.ttfChangaOne-Regular.ttfChangaOne-Italic.ttfVT323-Regular.ttfStarjedi.ttfPermanentMarker-Regular.ttfOrbitron-Bold.ttfMedievalSharp-Regular.woff2LuckiestGuy-Regular.ttfGugi.woff2Gugi.ttfCourier New.woff2Courier New.ttf
...
##### Load Korean fonts from file at startup
...
Full filepath to the preamble file, leave empty for default. If the file doesn't exist this option will be ignored.  
**Important:** Requires obsidian reload after change to take effect!
...
Taskbone offers a free service with a reasonable number of scans per month. If you want to use this feature more frequently, or you want to support the developer of Taskbone (as you can imagine, there is no such thing as 'free', providing this awesome OCR service costs some money to the developer of Taskbone), you can purchase a paid API key from [taskbone.com](https://www.taskbone.com/). In case you have purchased a key, simply overwrite this auto generated free-tier API-key with your paid key.
