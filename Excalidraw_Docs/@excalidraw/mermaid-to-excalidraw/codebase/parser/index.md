---
title: How the Parser works under the hood ?
source: https://docs.excalidraw.com/docs/@excalidraw/mermaid-to-excalidraw/codebase/parser/
---
...
## Parsing Mermaid diagram[​](#parsing-mermaid-diagram "Direct link to heading")
...
### Rendering Mermaid to Svg[​](#rendering-mermaid-to-svg "Direct link to heading")
...
### Parsing the mermaid syntax[​](#parsing-the-mermaid-syntax "Direct link to heading")
...
### Parsing the Diagram[​](#parsing-the-diagram "Direct link to heading")
...
## Converting to ExcalidrawElementSkeleton[​](#converting-to-excalidrawelementskeleton "Direct link to heading")
